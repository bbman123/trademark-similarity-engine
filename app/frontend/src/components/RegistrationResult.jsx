...
import { CheckCircle2, XCircle, AlertTriangle, ChevronDown, ChevronUp, Eye, Volume2, Globe, Ruler } from 'lucide-react';
              ...
              {result.top_matches.map((match, i) => (
                <div key={i} className="flex items-center justify-between p-2 bg-gray-50 rounded border border-gray-200">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center text-xs font-bold">
                      {i + 1}
                    </span>
                    <span className="text-sm text-gray-800">{match.trademark}</span>
                  </div>
